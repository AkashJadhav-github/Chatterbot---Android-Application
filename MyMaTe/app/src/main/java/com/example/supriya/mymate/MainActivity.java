package com.example.supriya.mymate;
...
import com.example.supriya.mymate.Adapter.CustomAdapter;
import com.example.supriya.mymate.Helper.HttpDataHandler;
import com.example.supriya.mymate.Models.ChatModel;
import com.example.supriya.mymate.Models.apiModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    private  class SimsimiAPI extends AsyncTask<List<ChatModel>,Void,String>{
        ...
        protected String doInBackground(List<ChatModel>... params) {
            //we will pass parameters api key and text from user to api endpoint
            String url  = String.format("http://sandbox.api.simsimi.com/request.p?key=%s&lc=en&ft=1.0&text=%s",getString(R.string.app_api),text);
